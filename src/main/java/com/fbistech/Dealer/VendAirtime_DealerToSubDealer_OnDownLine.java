...
public class VendAirtime_DealerToSubDealer_OnDownLine extends BasePage {

	
	public VendAirtime_DealerToSubDealer_OnDownLine (AndroidDriver driver)
	{
		super(driver);
	}
...
//	public void dealerToFundSubdealerDownline(String subDealerToRetailerDownline) throws Exception
	public String validateDealerVendAirtimeToSubdealer_OnDownline() throws Exception
	{
		
//		textField.sendKeys(subDealerToRetailerDownline);
		textField.sendKeys("*878*878*2347063079205*1#");
		call_Btn.click(); 
		Thread.sleep(5000);
