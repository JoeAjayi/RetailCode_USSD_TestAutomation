...
public class DirectFunding_DealerToRetailer_NotOnDownline extends BasePage {

	
	public DirectFunding_DealerToRetailer_NotOnDownline(AndroidDriver driver)
	{
		super(driver);
	}
...
//	public void dealerToFundSubdealerDownline(String subDealerToRetailerDownline) throws Exception
	public String validateDealerFundRetailerNotOnDownline() throws Exception
	{
		
//		textField.sendKeys(subDealerToRetailerDownline);
		textField.sendKeys("*878*878*33*692571*1#");
		call_Btn.click(); 
		Thread.sleep(5000);
