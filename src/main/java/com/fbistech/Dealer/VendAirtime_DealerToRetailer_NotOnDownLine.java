...
public class VendAirtime_DealerToRetailer_NotOnDownLine extends BasePage {

	
	public VendAirtime_DealerToRetailer_NotOnDownLine (AndroidDriver driver)
	{
		super(driver);
	}
...
//	public void dealerToFundSubdealerDownline(String subDealerToRetailerDownline) throws Exception
	public String validateDealerVendAirtimeToRetailer_NotOnDownline() throws Exception
	{
		
//		textField.sendKeys(subDealerToRetailerDownline);
		textField.sendKeys("*878*878*08146520302*1#");
		call_Btn.click(); 
		Thread.sleep(5000);
