...
public class DirectFunding_RetailerToDealer_Upline extends BasePage {

	
	public DirectFunding_RetailerToDealer_Upline (AndroidDriver driver)
	{
		super(driver);
	}
...
//	@AndroidFindBy(xpath = "//*[@resource-id='android:id/message']")
	...
	public String validateRetailerFundDealer_Upline() throws Exception
	{
