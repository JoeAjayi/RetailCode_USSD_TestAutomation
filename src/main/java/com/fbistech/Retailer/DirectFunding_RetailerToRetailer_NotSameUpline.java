...
public class DirectFunding_RetailerToRetailer_NotSameUpline extends BasePage {

	
	public DirectFunding_RetailerToRetailer_NotSameUpline (AndroidDriver driver)
	{
		super(driver);
	}
...
//	@AndroidFindBy(xpath = "//*[@resource-id='android:id/message']")
	...
	public String validateRetailerFundRetailer_NotSameUpline() throws Exception
	{
//		textField.sendKeys(subDealerToRetailerDownline);
		textField.sendKeys("*878*878*33*879080*1#");
		dial_Button.click(); 
		Thread.sleep(5000);
