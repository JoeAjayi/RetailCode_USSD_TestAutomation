...
public class OnboardingDirectly_RetailerUnder_FBIS_SubDealer extends BasePage {
	
	public OnboardingDirectly_RetailerUnder_FBIS_SubDealer(AndroidDriver driver)
	{
		super(driver);
	}
...
//	*878*22*3*Sub-dealer-RCode#....Retailer onboard under Sub-dealer
	...
	public String validateRetailerOnboardDirectlyUnderSubDealer() throws Exception
...
//		Select 2 to Register as Sub-dealer
		text_InputField.sendKeys("2");
		sendText_Button.click();
		Thread.sleep(3000);
		
//		Select 1 to Register under sub-dealer
		text_InputField.sendKeys("1");
		sendText_Button.click();
		Thread.sleep(3000);
		
		
//		Enter 5 digits Sub-Dealer code 
		text_InputField.sendKeys("00649");
		sendText_Button.click();
		Thread.sleep(3000);
