...
public class DirectFunding_RetailerToSubDealer_NotUpline extends BasePage {

	
	public DirectFunding_RetailerToSubDealer_NotUpline (AndroidDriver driver)
	{
		super(driver);
	}
...
//	@AndroidFindBy(xpath = "//*[@resource-id='android:id/message']")
	...
	public String validateRetailerFundSubDealer_NotUpline() throws Exception
	{
//		textField.sendKeys(subDealerToRetailerDownline);
		textField.sendKeys("*878*878*33*37897*1#");
		dial_Button.click(); 
		Thread.sleep(5000);
